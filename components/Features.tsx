...
function Features () {
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 md:max-w-3xl lg:grid-cols-3 lg:max-w-5xl xl:grid-cols-4 xl:max-w-6xl mx-auto gap-4 px-2 lg:px-4 mt-4">
            <div className="col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4 bg-[#070D0D] border border-gray-700 hover:border-gray-600 border-dashed rounded-xl shadow-md cursor-pointer">
