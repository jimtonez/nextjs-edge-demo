      ...
      <div className='space-y-4'>
        ...
        <div className='col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4'>
            <div className="flex flex-row w-full items-center justify-start space-x-2 pb-2 md:pb-4 border-b border-gray-700">
                <button onClick={() => setTabState("upcoming")} className="text-sm text-gray-600 hover:bg-gray-600 hover:text-white h-8 w-auto px-2 border border-gray-600 hover:border-none rounded-full">Upcoming Events</button>
                <button onClick={() => setTabState("teams")} className="text-sm text-gray-600 hover:bg-gray-600 hover:text-white h-8 w-auto px-2 border border-gray-600 hover:border-none rounded-full">Teams</button>
            </div>
        </div>
        </section>
        {session ? (
