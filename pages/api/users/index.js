...
export default async (req, res) => {
    switch (req.method) {
        case "GET":
            const getUser = await axios.get(`https://route-ed-quarkus-backend-ssl-cc-betting-demo.apps.cluster-r8szc.r8szc.sandbox1991.opentlc.com/customer/membership`, {"email": "test@test.com"} )
